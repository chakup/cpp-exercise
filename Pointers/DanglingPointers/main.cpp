...
int main()
{
    ...
    std::cout << std::endl;
    std::cout << "Case 1 : Uninitialied pointer : ." << std::endl;
    ...
    // p_number4 points to deleted memory. Dereferencing it will lead to undefined behaviour : Crash/garbage or whatever
